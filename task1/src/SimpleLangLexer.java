...
public class SimpleLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LParen", "Comma", "RParen", "LBrace", "Semicolon", "RBrace", "Eq", "More", 
			"MoreEq", "Less", "LessEq", "Plus", "Times", "Minus", "Div", "Assign", 
			"Print", "Space", "NewLine", "If", "Then", "Else", "While", "Repeat", 
			"Until", "Do", "And", "Or", "XOR", "IntType", "BoolType", "UnitType", 
