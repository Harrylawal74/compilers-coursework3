...
public interface SimpleLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code DivBinop}
	 * labeled alternative in {@link SimpleLangParser#binop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDivBinop(SimpleLangParser.DivBinopContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ExponentBinop}
	 * labeled alternative in {@link SimpleLangParser#binop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExponentBinop(SimpleLangParser.ExponentBinopContext ctx);
}